...
We also provide a  few [Docker Compose](https://docs.docker.com/compose/) "alternatives" in our some of our code directories so developers can compare and contrast a Docker workflow with a Kubernetes workflow. 
